            ...
            {eventData && 
                <div className="flex flex-col space-y-4">
                    <section className="flex flex-col">
                        ...
                        <span className="text-lg font-medium text-gray-700 dark:text-gray-300">{eventData.event.eventCode.toUpperCase()} &#x2022; Week {eventData.event.weekNumber}</span>
                    </section>
                    ...
                    <section className="flex flex-col">
                        <span className="text-xl font-semibold text-gray-950 dark:text-gray-100">Venue</span>
                        <span className="text-lg text-gray-700 dark:text-gray-300">{eventData.event.venue}</span>
                        <span className="text-md text-gray-700 dark:text-gray-300">{eventData.event.location}</span>
                    </section>
                    <Table id="teams">
