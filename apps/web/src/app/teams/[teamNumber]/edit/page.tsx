...
export default function Team({
	...
	useEffect(() => {
		...
		Object.keys(teamDataState).forEach((key) => {
			if (
				teamDataState![key as keyof TeamData["scouting"]] !==
				teamData!.scouting[key as keyof TeamData["scouting"]]
			)
				valueModified = true;
		});
						...
						<Table>
							<TableBody>
								<TableRow>
									...
									<TableCell>
										<Combobox
											...
											emptyResult="Invalid drivetrain"
											options={drivetrainOptions}
											defaultValue={
												drivetrainOptions.find(
													(d) => d.value === teamDataState.drivetrain,
												)?.label
											}
											onChange={(newValue) =>
												setTeamDataState({
													...teamDataState,
													drivetrain: newValue as "other",
												})
											}
										/>
									</TableCell>
										...
										<Combobox
											...
											defaultValue={
												programmingLanguageOptions.find(
													(p) => p.value === teamDataState.programmingLanguage,
												)?.label
											}
											onChange={(newValue) =>
												setTeamDataState({
													...teamDataState,
													programmingLanguage: newValue as "java",
												})
											}
										/>
									</TableCell>
								...
								<TableRow>
									...
									<TableCell>
										<Checkbox
											defaultChecked={teamDataState.canScoreCoral}
								...
								<TableRow>
									...
									<TableCell>
										<Checkbox
											defaultChecked={teamDataState.canScoreAlgae}
											onCheckedChange={(checked) =>
												setTeamDataState({
													...teamDataState,
													canScoreAlgae: !!checked,
												})
											}
										/>
									</TableCell>
								...
								<TableRow>
									...
									<TableCell>
										<Input
											...
											className="w-min"
											min={0}
											defaultValue={teamDataState.averageCoralCycled}
											onChange={(e) =>
												setTeamDataState({
													...teamDataState,
													averageCoralCycled: e.target.valueAsNumber,
												})
											}
										/>
									</TableCell>
								...
								<TableRow>
									...
									<TableCell>
										<Input
											...
											className="w-min"
											min={0}
											defaultValue={teamDataState.mostCoralCycled}
											onChange={(e) =>
												setTeamDataState({
													...teamDataState,
													mostCoralCycled: e.target.valueAsNumber,
												})
											}
										/>
									</TableCell>
								...
								<TableRow>
									...
									<TableCell>
										<Input
											...
											className="w-min"
											min={0}
											defaultValue={teamDataState.maxCoralScoredInAuto}
											onChange={(e) =>
												setTeamDataState({
													...teamDataState,
													maxCoralScoredInAuto: e.target.valueAsNumber,
												})
											}
										/>
									</TableCell>
								...
								<TableRow>
									...
									<TableCell>
										<Checkbox
											defaultChecked={teamDataState.canScoreAlgaeInAuto}
											onCheckedChange={(checked) =>
												setTeamDataState({
													...teamDataState,
													canScoreAlgaeInAuto: !!checked,
												})
											}
										/>
									</TableCell>
								...
								<TableRow>
									...
									<TableCell>
										<Checkbox
											defaultChecked={teamDataState.canLeaveInAuto}
											onCheckedChange={(checked) =>
												setTeamDataState({
													...teamDataState,
													canLeaveInAuto: !!checked,
												})
											}
										/>
									</TableCell>
								...
								<TableRow>
									...
									<TableCell>
										<Checkbox
											defaultChecked={teamDataState.canShallowCageClimb}
											onCheckedChange={(checked) =>
												setTeamDataState({
													...teamDataState,
													canShallowCageClimb: !!checked,
												})
											}
										/>
									</TableCell>
								...
								<TableRow>
									...
									<TableCell>
										<Checkbox
											defaultChecked={teamDataState.canDeepCageClimb}
											onCheckedChange={(checked) =>
												setTeamDataState({
													...teamDataState,
													canDeepCageClimb: !!checked,
												})
											}
										/>
									</TableCell>
						...
						<AlertDialogContent>
							...
							<AlertDialogFooter>
								...
								<AlertDialogAction
									onClick={() => {
										saveCallback();
										toast(`Saved Team Data for ${teamNumber}`);
										setConfirmSave(false);
									}}
								>
									Continue
